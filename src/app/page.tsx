...
const App = () => {
  ...
  //             "required": {
  //               "value": true,
  //               "message": "Population selection is required"
  //             }
  //           },
  //           "flow": [
  //             {
  ...
  //               "placeholder": "Select population subgroup",
  //               "dependsOn": "group",
  //               "optionsSource": {
  ...
  //     },
  //     "getStates": {
  //       "description": "Fetch list of states for selected country",
  //       "async": true
  //     },
  //     "getCities": {
  //       "description": "Fetch list of cities for selected state",
  //       "async": true
  //     },
  //     "getDistricts": {
  //       "description": "Fetch list of districts for selected city",
  //       "async": true
  //     }
  //   }
  // };
  ...
  const formConfig = {
    "title": "Enhanced Form with Dynamic Flows",
    "description": "Submit data with dynamic dependent dropdowns",
    "type": "standard",
    "submitButtonLabel": "Submit",
    "theme": {
      "primaryColor": "#2563eb",
    ...
    "fields": [
      {
        ...
        "fields": [
          ...
          },
          {
            ...
            "type": "dynamic-flow",
            "label": "Population Selection*",
            "tooltip": "Navigate through the hierarchy to select your target population",
            "flow": [
              {
                "id": "populationGroup",
                // "label": "Population Group*",
              ...
              },
              {
                ...
                "placeholder": "Select specific population",
                "optionsSource": {
                  "function": "getPopulations",
                ...
                //   "required": {
                //     "value": true,
                //     "message": "Specific Population is required"
                //   }
                // }
              }
            ],
            "outputStepId": "population",
            "flowLayout": "vertical",
            "showAllSteps": true,
            "validation": {
              "required": {
                "value": true,
                "message": "You must select a population"
              }
            }
          },
          {
      ...
      //       "helpText": "Choose a product through our catalog hierarchy",
      //       "flow": [
      //         {
      //           "id": "department",
      //           "label": "Department",
    ...
    "customFunctions": {
      ...
      "getDepartments": {
        "description": "Fetch list of departments",
        "async": true
      },
      "getCategories": {
        "description": "Fetch list of categories for selected department",
        "async": true
      },
      "getSubcategories": {
        "description": "Fetch list of subcategories for selected category",
        "async": true
      },
      "getProducts": {
        "description": "Fetch list of products for selected subcategory",
        "async": true
      }
    }
  };
        ...
        "fields": [
          {
            ...
            "optionsSource": { "function": "getCountries" }
          },
          {
            "name": "state",
            "label": "State/Province*",
  ...
  const jsonString = JSON.stringify(formConfig1);
